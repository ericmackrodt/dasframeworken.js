...
const createRootLine = (varName: string, selector: string, key: string, parent: string) => `const ${varName} = builder.createRoot('${selector}', ${key}${parentParameter(parent)});\r\n`;
const createElementLine = (varName: string, nodeName: string, parent: string) => `const ${varName} = builder.createElement('${nodeName}'${parentParameter(parent)});\r\n`;
const createAttributeLine = (key: string, value: string, parentVarName: string) => `builder.setAttribute('${key}', '${value}', ${parentVarName});\r\n`;
const createEventLine = (event: string, value: string, parentVarName: string) => `builder.setEvent('${event}', (controller, $event) => controller.${value}, ${parentVarName});\r\n`;
const createBindingLine = (property: string, parentVarName: string) => `builder.setBinding('${property}', ${parentVarName});\r\n`;
const createDirectiveLine = (directive: string, value: string, parent: string) => `builder.setDirective('${directive}', '${value}', ${parent});\r\n`;
const setTextLine = (property: string, parentVarName: string) => `builder.setText('${property}', ${parentVarName});\r\n`;
const boundTextLine = (property: string, parentVarName: string) => `builder.boundText('${property}', ${parentVarName});\r\n`;
